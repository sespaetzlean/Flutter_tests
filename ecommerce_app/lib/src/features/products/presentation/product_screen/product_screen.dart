...
//* falls das gesamte Widget bei einem Update durch den Provider neu gebaut werden soll
...
//   }
// }
//*falls nur ein Teil neu gebaut werden soll (Consumer nutzen), hier also nur der Body.
    ...
    return Scaffold(
      ...
      body: Consumer(
        builder: (context, ref, _) {
          ...
          //exp: hier zur Übung mit AsyncValueWidget
